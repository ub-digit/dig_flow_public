...
run the rvm script via home folder: 
  source /home/<user>/.rvm/script/rvm
...
Add the following content, change the fields marked by asterisks
  ...
  Enable site: > sudo a2ensite dflow
...
/etc/apache2/mods-available/passenger.load
  LoadModule passenger_module /home/jimmy/.rvm/gems/ruby-1.9.3-p550/gems/passenger-4.0.53/buildout/apache2/mod_passenger.so

/etc/apache2/mods-available/passenger.conf
  <IfModule mod_passenger.c>
    PassengerRoot /home/jimmy/.rvm/gems/ruby-1.9.3-p550/gems/passenger-4.0.53
    PassengerDefaultRuby /home/jimmy/.rvm/gems/ruby-1.9.3-p550/wrappers/ruby
  </IfModule>
